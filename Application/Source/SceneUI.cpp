...
void SceneUI::RenderEntity(Entity* entity, bool enableLight)
{
...
bool SceneUI::CreateButton(float buttonTop, float buttonBottom, float buttonRight, float buttonLeft)
{
